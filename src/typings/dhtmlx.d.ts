...
type IBoolCallable = (result: boolean) => void;
...
declare namespace dhx {
	...
	function ajax(): dhtmlxAjax;
	function ajax(url: string, callback?: ICallable): Promise<any>;

	const promise: IDhxPromise;
...
interface dhtmlxAjax {
	del(url: string, params?: string, callback?: ICallable): Promise<any>;
	get(url: string, callback?: ICallable): Promise<any>;
	getSync(url: string): Promise<any>;
	post(url: string, params?: string, callback?: ICallable): Promise<any>;
	postSync(url: string, params?: string): Promise<any>;
	put(url: string, params?: string, callback?: ICallable): Promise<any>;
	query(method: string, url: string, data: string, async: boolean, callback?: ICallable, headers?: any): Promise<any>;
}
...
declare class dhtmlXMenuObject {
	...
	setOverflowHeight(itemsNum: number|string): void;
